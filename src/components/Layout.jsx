...
import posterImage from '@/images/alphabits.png'
...
function AboutSection(props) {
  ...
  return (
    <section {...props}>
      ...
      >
       Join David Flanagan (Rawkode) and Brian Ketelsen (bketelsen) as they each share one bit of new technology or software that they've found each week. Learn about new and upcoming software before it hits the mainstream. 
      </p>
      {!isExpanded && (
        <button
          type="button"
...
export function Layout({ children }) {
  let hosts = ['David Flanagan', 'Brian Ketelsen']
        ...
        <div className="relative z-10 mx-auto px-4 pb-4 pt-10 sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 lg:py-12 lg:px-8 xl:px-12">
          ...
          <div className="mt-10 text-center lg:mt-12 lg:text-left">
            <p className="text-xl font-bold text-slate-900">
              <Link href="/">ALPHA BITS</Link>
            </p>
            <p className="mt-3 text-lg font-medium leading-8 text-slate-700">
              Exploring the shiny new bits. We get the papercuts so you don't have to.
            </p>
          </div>
